...
defined('PROJECT_NAME')        OR define('PROJECT_NAME',"Prerna Grow Point"); 
...
if(isset($_SERVER['HTTP_HOST']) && ($_SERVER['HTTP_HOST']=='localhost')){
	...
	defined('DB_NAME')		? null : define('DB_NAME','db_prerna');
}
else{
	defined('DB_HOST')      ? null : define('DB_HOST', '127.0.0.1');
	defined('DB_USER')      ? null : define('DB_USER', 'u711511560_user_prerna');
	defined('DB_PASSWORD')  ? null : define('DB_PASSWORD', 'Prerna@123#$');
	defined('DB_NAME')      ? null : define('DB_NAME', 'u711511560_db_prerna');
}