                                ...
                                <div class="card light-bg">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <?php
                                                    if((empty($acc_details['bank'])) || (empty($acc_details['account_no']))){
                                                        echo "<div class='text-center'><h2 class='text-danger'>Please Add Account Details Before Activation!</h2>";
                                                        echo "<a href='".base_url('profile/accdetails/')."' class='btn btn-sm btn-info'>Add Account Details</a></div>";
                                                    }
                                                    else{ 
                                                ?>
                                                <?php echo form_open_multipart('deposits/savedeposit', 'id="myform" onSubmit="return validate();"'); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <?php
                                                            ...
                                                            $trans_type=array();
														    $trans_type['request']="Request";
                                                            $trans_type['Online']="Online";
                                                            $value='request';
                                                            $button=str_replace('Save Activation Request','Activate Account',$button);
