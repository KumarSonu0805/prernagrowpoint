                                                        ...
                                                        <?php
                                                            ...
                                                            if(is_array($members)){$i=0;
                                                                foreach($members as $member){
                                                                    ...
                                                                    if(strtolower($member['trans_type'])=='online'){
                                                                        $image='';
                                                                    }
                                                                    $type=$member['type']=='deposit'?'Money Transfer':'Activation';
                                                        ?>
                                                        <tr>
                                                            <td><?= $i; ?></td>
                                                            ...
                                                            <td><?= (($member['type']=='deposit' || $member['type']=='activation') && ($member['trans_type']!='CASH' && $member['trans_type']!='Online'))?$member['details']."<br>".$image:$member['details']; ?></td>
                                                            <?php
                                                                if($this->session->role=='admin'){
                                                            ?>
                                                            <td class="">
                                                                <form action="<?php echo base_url('deposits/approvedeposit'); ?>" method="post" onSubmit="return validate('accept');" class="float-left" style="margin-right:5px;">
                                                                    <button type="submit" value="<?php echo $member['id'] ?>" name="request_id" class="btn btn-sm btn-success">Approve</button>
                                                                </form>
                                                                <form action="<?php echo base_url('deposits/rejectdeposit'); ?>" method="post" onSubmit="return validate('reject');" class="float-left">
