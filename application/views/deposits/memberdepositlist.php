                                                        ...
                                                        <?php
                                                            ...
                                                            if(is_array($members)){$i=0;
                                                                foreach($members as $member){
                                                                    ...
                                                                    $type=$member['type']=='transfer'?'Money Transfer':'Activation';
                                                        ?>
                                                        <tr>
                                                            <td><?= $i; ?></td>
                                                            ...
                                                            <td><?= (($member['type']=='deposit' || $member['type']=='activation') && $member['trans_type']!='CASH')?$member['details']."<br>".$image:$member['details']; ?></td>
                                                            <td class="">
