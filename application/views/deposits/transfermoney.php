...
<?php
    ...
    $admin_acc_details=$member_acc_details;
                                            ...
                                            <div class="col-md-5">
                                                <?php echo form_open_multipart('deposits/savedeposit', 'id="myform" onSubmit="return validate();"'); ?>
                                                    ...
                                                    <div class="form-group <?= !$to_regid?'d-none':'' ?>">
                                                        <?php
                                                            echo create_form_input("text","","Transfer To Member ID",true,$donation['username'],array("readonly"=>"true")); 
                                                            echo create_form_input("hidden","to_regid","",false,$donation['to_regid'],array("id"=>"to_regid")); 
                                                        ?>
                                                        <div id="name" class="lead text-success"><?= $donation['name'] ?></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <?php
                                                    ...
                                                    <div class="form-group">
                                                        <?php
                                                            ...
                                                            $value='';
                                                            if($donation['to_regid']==1){
                                                                $trans_type=array();
                                                                $trans_type['Online']="Online";
                                                                $value='Online';
                                                                $button=str_replace('Save Deposit','Transfer Money',$button);
                                                            }
                                                            echo create_form_input("select","trans_type","Transaction Type",true,$value,array("id"=>"trans_type"),$trans_type); 
                                                        ?>
                                                    </div>
                                                    ...
                                                    <?php
                                                        echo create_form_input("hidden","ref_id","",false,$donation['id']); 
