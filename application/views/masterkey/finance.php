                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <?= form_open_multipart('masterkey/savefinance/'); ?>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="submit" class="btn btn-success waves-effect waves-light" name="savefinance" value="Save Finance Company">
...
<script>
                                $(document).ready(function(e) {
                                    $('body').on('click','.edit-btn',function(){
                                        $.ajax({
                                            type:"post",
                                            url:"<?= base_url('masterkey/getfinance/'); ?>",
                                            data:{id:$(this).val()},
                                            success:function(data){
                                                ...
                                                $('input[name="savefinance"]').attr('name','updatefinance').val('Update Finance Company');
                                            }
                                        });
                                    });
                                    $('.cancel-btn').click(function(){
                                        ...
                                        $('input[name="updatefinance"]').attr('name','savefinance').val('Save Finance Company');
                                    });

                                    var url="<?= base_url('masterkey/finance/?type=data'); ?>";
                                    var columns=[
                                            { 
                                                title: "Sl.No.", 
                                                field: "serial", 
